...
from .types import FloatType, OverlayType, run_once
...
type=choices
default=window
choices=window,tab,os-window,overlay,overlay-main,float-in-window,float-in-tab,background,clipboard,primary
